...
public class RazerItemGrab : MonoBehaviour
{

    public static LineRenderer layser;        // 레이저
    ...
    void Update()
    {
        ...
        // 충돌 감지 시
        if (Physics.Raycast(transform.position, transform.forward, out Collided_object, raycastDistance, 1 << 9))
        {
            ...
            //}
            layser.enabled = true;
            layser.material.color = new Color(255, 255, 0, 0.5f);
        }
        ...
        else
        {
            ...
            //layser.material.color = new Color(204, 204, 204, 0.5f);
